...
- шрифты находятся в папке `src/fonts`
  - шрифты конвертируюься автоматически в [форматы](https://caniuse.com/#search=woff) `.woff` и `.woff2`
  - шрифты подключаются в файл `src/styles/base/_fonts.scss`
  - если требуется поменять илид обавить какие-либо шрифты, необходимо предварительно удалить файл шрифтов из `src/styles/base/_fonts.scss`

### Изображения

- изображения находятся в папке `src/img`
  - для вставки изображение необходим сниппет для игнорирования их форматором prettier
  - изображения автоматически конвертируются в формат `.webp`. Подробная информация по использованию [тут](https://vk.com/@vk_it-webp)
  - изображение для генерации фавиконок должно находиться в папке `src/img/favicon` и иметь размер не менее `1024px x 1024px`
  - в конечном файле html в зависимости от браузера будут поодсталяться либо `.webp` либо `.jpg`
